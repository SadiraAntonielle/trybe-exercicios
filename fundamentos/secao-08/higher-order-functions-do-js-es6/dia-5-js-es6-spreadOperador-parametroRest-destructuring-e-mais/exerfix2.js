...
const user = {
  ...
  const userEJobInfos = {...user, ...jobInfos}; // feito o que foi pedido
/* console.log(userEJobInfos); */
...
const  {name, age, nationality, profession, squad, squadInitials} = userEJobInfos;

const escrevendoFrase = `Hi, my name is ${name}, i'm ${age} years old an i'm ${nationality}. I work as a ${profession} and my ${squad} is ${squadInitials}.`

/* console.log(escrevendoFrase); */
